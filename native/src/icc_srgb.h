// Auto-extracted from vendor/pcdtojpeg/src/main.cpp's ksRGBProfile array
// (the JPEG APP2 "ICC_PROFILE" marker wrapper bytes were stripped, leaving
// the raw ICC profile payload). That array embeds the HP/Microsoft
// "sRGB IEC61966-2.1" profile, licensed by Hewlett-Packard Company for free
// use/copy/distribution provided the file is unmodified and the HP copyright
// notice below is retained. See http://www.color.org and the notice in
// jpeg_writer.cpp for the full licensing text.
#ifndef PCD_ICC_SRGB_H
#define PCD_ICC_SRGB_H

#include <cstddef>
#include <cstdint>

// (c) Copyright 1998 Hewlett-Packard Company
static const uint8_t kIccSRGBProfile[] = {
...
static const size_t kIccSRGBProfileLen = sizeof(kIccSRGBProfile);

#endif // PCD_ICC_SRGB_H
